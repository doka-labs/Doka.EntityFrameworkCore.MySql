...
through model differencing, migration source, snapshots, and generated SQL. It
prevents silent database-default drift and rejects ambiguous or incompatible
transitions before execution. Updating the package does not rewrite migration
source generated by an affected version; regenerate unpublished affected
migrations after updating to `10.4.1`.
...
dotnet package add Doka.EntityFrameworkCore.MySql.NetTopologySuite --version 10.4.1
dotnet package add Doka.Caching.MySql --version 10.4.1
```
