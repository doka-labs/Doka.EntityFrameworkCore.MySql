# D-014 -- MySQL 8.0 Support-Matrix Entscheidung

- **Status:** Accepted
- **Date:** 2026-05-16
- **Scope:** Provider support matrix advertised on the v1.0 release, README, CHANGELOG, csproj description, scheduled CI compatibility matrix

## Context

MySQL 8.0 reaches the end of Extended Support on 2026-04-30 (per
[endoflife.date/mysql](https://endoflife.date/mysql)). The first publishable
...
[endoflife.date/mariadb](https://endoflife.date/mariadb) entry lists 11.8 as
