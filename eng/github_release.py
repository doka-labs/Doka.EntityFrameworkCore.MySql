...
try:
    from eng import nuget_publication, release_evidence
except ModuleNotFoundError:
    # Unit tests import through ``eng`` while GitHub Actions executes this file
    # directly. Both entry points must exercise the same implementation.
    import nuget_publication
