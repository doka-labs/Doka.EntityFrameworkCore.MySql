...
project_template="${repo_root}/eng/templates/nuget-readback.csproj.template"
release_version="${1:-}"
packages_dir="${2:-}"
evidence_dir="${3:-}"
temporary_root=""
...
cp "${repo_root}/eng/templates/cache-readback.csproj.template" "${cache_consumer_root}/CacheConsumer.csproj"
