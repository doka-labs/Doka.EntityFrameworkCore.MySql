    ...
    def _bdn_report() -> dict[str, Any]:
        ...
        return {
            ...
            "Benchmarks": [
                ...
                benchmark(
                    "BulkInsertSqlGenerationBenchmark",
                    "GenerateWriteOnly1000Rows",
                    100,
                    64,
                ),
                benchmark(
                    "BulkInsertSqlGenerationBenchmark",
                    "GenerateWriteOnly1000RowsWithPerRowFiltering",
                    400,
                    100000,
                ),
                benchmark(
                    "BulkInsertSqlGenerationBenchmark",
                    "CompareSameShape1000Times",
                    100,
                    0,
                ),
                benchmark(
                    "BulkInsertSqlGenerationBenchmark",
                    "CompareSameShape1000TimesWithLinq",
                    500,
                    100000,
                ),
                benchmark("JsonComparerBenchmark", "JsonNodeEqualsLoop", 100, 0),
                benchmark("JsonComparerBenchmark", "JsonNodeHashLoop", 100, 0),
                benchmark(
                    "JsonComparerBenchmark",
                    "BidirectionalJsonNodeDeepEqualsLoop",
                    200,
                    0,
                ),
                benchmark("JsonComparerBenchmark", "SerializedJsonNodeEqualsLoop", 200, 1000),
                benchmark("JsonComparerBenchmark", "SerializedJsonNodeHashLoop", 200, 1000),
                benchmark(
                    "ParameterSizeInterceptorBenchmark",
                    "Process1000WithinSizeParameters",
                    100,
                    0,
                ),
                benchmark(
                    "ParameterSizeInterceptorBenchmark",
                    "Process1000WithinSizeParametersWithValueWriteback",
                    1000,
                    40,
                ),
                benchmark(
                    "MigrationOperationHandlerGenerationBenchmark",
                    "Generate256DdlCommentSqlModeScopes",
                    100,
                    920584,
                ),
                benchmark(
                    "TemporalLiteralBenchmark",
                    "GenerateTimeOnlyPrecision6Literal",
                    100,
                    96,
                ),
                benchmark(
                    "TemporalLiteralBenchmark",
                    "GeneratePositiveTimeSpanPrecision6Literal",
                    100,
                    80,
                ),
                benchmark(
                    "TemporalLiteralBenchmark",
                    "GenerateNegativeBoundaryTimeSpanPrecision6Literal",
                    100,
                    88,
                ),
                benchmark(
